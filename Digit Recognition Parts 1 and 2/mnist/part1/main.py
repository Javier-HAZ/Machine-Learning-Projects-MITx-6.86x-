...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    # err_mod3 = compute_test_error_mod3(test_x,test_y_mod3, theta, temp_parameter)
    # print("test_error_mod3: ", err_mod3)

    return test_error


#print('softmax test_error PCA (Cubic features applied) =', run_softmax_on_MNIST(temp_parameter=1))
